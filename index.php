...
<head>
    ...
    <meta name="description" content="I'm Daffa Pratama Putrs Siswanto, a web developer based in Kudus, Central Java, I'm an Information Technology student at UIN Walisongo. As a beginner in IT, I'm very enthusiastic about developing intuitive, SEO-friendly, and visually appealing websites. I'm fully committed to working on your project and delivering scalable web solutions. ">
    <meta name="keywords" content="web developer, portfolio, Daffa Pratama, dap, Indonesia, full-stack, SEO, responsive design">
    <meta name="author" content="Daffa Pratama">
    <meta property="og:title" content="Daffa Pratama - Full-Stack Web Developer Portfolio">
    ...
    <title>Daffa Pratama - Full-Stack Web Developer</title>
    ...
    <script>
        window.gsap || document.write('<script src="assets/js/gsap.min.js"><\/script>');
    </script>
    <script>
        window.ScrollTrigger || document.write('<script src="assets/js/ScrollTrigger.min.js"><\/script>');
    </script>
    <script>
        window.Swal || document.write('<script src="assets/js/sweetalert2.min.js"><\/script>');
    </script>
...
<body>
    <!-- Header -->
    <header>
        <a href="#home" class="logo">Daffa <span>Pratama</span></a>
        ...
        <section class="home" id="home">
            <div class="home-content">
                <div class="home-img">
                    ...
                    ?>
                    <img
                        src="<?php echo htmlspecialchars(getImagePath('assets/img/aku.jpg')); ?>"
                        srcset="<?php echo htmlspecialchars(getImagePath('assets/img/aku.jpg')); ?> 280w, <?php echo htmlspecialchars(getImagePath('assets/img/aku.jpg')); ?> 560w"
                ...
                <div class="home-text">
                    <span>Hello, I'm</span>
                    <h1 class="typewrite" data-period="3000" data-type='["Daffa Pratama", "Web Developer", "Student"]'>
                        Daffa Pratama Putra Siswanto
                    </h1>
                    <h2>Student of Information Technology</h2>
                    <p>From Kudus, Central Java, I'm an Information Technology student at UIN Walisongo. As a beginner in IT, I'm very enthusiastic about developing intuitive, SEO-friendly, and visually appealing websites. I'm fully committed to working on your project and delivering scalable web solutions.</p>
                    <div class="social">
                        <a href="https://github.com/dhappa234" target="_blank" rel="noopener noreferrer" aria-label="GitHub Profile"><i class="bx bxl-github"></i></a>
                        <a href="https://www.instagram.com/alllodaffa_/" target="_blank" rel="noopener noreferrer" aria-label="Instagram Profile"><i class="bx bxl-instagram"></i></a>
                        <a href="https://www.linkedin.com/in/daffa-pratama-794307314/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Profile"><i class="bx bxl-linkedin"></i></a>
                    </div>
            ...
            <script type="application/ld+json">
                {
                    ...
                    "@type": "Person",
                    "name": "Daffa Pratama Putra Siswanto",
                    ...
                    "sameAs": [
                        "https://github.com/dhappa234",
                        "https://instagram.com/fhaq25_",
                        "https://www.linkedin.com/in/daffa-pratama-794307314/"
                    ]
                }
            </script>
        </section>
        ...
        <section class="about" id="about">
            ...
            <div class="about-container">
                <div class="about-img">
                    <img
                        src="<?php echo htmlspecialchars(getImagePath('assets/img/aku.jpg')); ?>"
                        srcset="<?php echo htmlspecialchars(getImagePath('assets/img/aku.jpg')); ?> 350w, <?php echo htmlspecialchars(getImagePath('assets/img/aku.jpg')); ?> 700w"
                        sizes="(max-width: 1024px) 350px, 450px"
                        alt="Daffa Pratama working on a project"
                        loading="lazy">
                </div>
                <div class="about-text">
                    <p>I'm Daffa Pratama Putrs Siswanto, a web developer based in Kudus, Central Java, I'm an Information Technology student at UIN Walisongo. As a beginner in IT, I'm very enthusiastic about developing intuitive, SEO-friendly, and visually appealing websites. I'm fully committed to working on your project and delivering scalable web solutions. <a href="#services">Explore my services</a> or <a href="#contact">contact me</a> to discuss your project.</p>
                    <div class="information">
                        <div class="info-box"><i class="bx bx-user"></i> <span>Daffa Pratama</span></div>
                        <div class="info-box"><i class="bx bxl-linkedin"></i> <span><a href="https://www.linkedin.com/in/musthofa-kamaluddin-8338812a1/" target="_blank">daffa-pratama-794307314</a></span></div>
                        <div class="info-box"><i class="bx bxs-envelope"></i> <span><a href="mailto:daffacs45@gmail.com">daffacs45@gmail.com</a></span></div>
                    </div>
                    <a href="#contact" class="btn">Get in touch</a>
                </div>
            </div>
    ...
    <footer class="footer">
        <div class="footer-content">
            ...
            <div class="footer-social">
                <a href="https://instagram.com/alllodaffa_" target="_blank" rel="noopener noreferrer" aria-label="Instagram Profile"><i class="bx bxl-instagram"></i></a>
                <a href="https://www.linkedin.com/in/daffa-pratama-794307314/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Profile"><i class="bx bxl-linkedin"></i></a>
                <a href="https://github.com/dhappa234" target="_blank" rel="noopener noreferrer" aria-label="GitHub Profile"><i class="bx bxl-github"></i></a>
            </div>
        </div>
    </footer>
    <div class="copyright">© 2025 Daffa Pratama. All Rights Reserved.</div>
